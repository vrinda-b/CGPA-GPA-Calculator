...
class BiotechSem6 extends StatefulWidget {
  @override
  S6 createState() => S6();
}
      ...
      body: new Container(
        ...
        padding: new EdgeInsets.all(32.0),
          child : new Column(
            ...
            Text('Bioinformatics', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            ...
            child :
            //Printing Item on Text Widget 
            Text('Genetic Engineering', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value2,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Applied Chemical Reaction Engineering', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value3,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
          ...
          DropdownButton<String>(
            ...
            child :
            //Printing Item on Text Widget 
            Text('Bioprocess Lab-II', style: TextStyle(fontSize: 15, color: Colors.black54))),
          DropdownButton<String>(
            value: value7,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Genetic Engineering Lab', style: TextStyle(fontSize: 15, color: Colors.white60))),
          DropdownButton<String>(
            value: value8,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
