      ...
      body: new Container(
        ...
        padding: new EdgeInsets.all(32.0),
          ...
          DropdownButton<String>(
            ...
            child :
            //Printing Item on Text Widget 
            Text('Programming in C', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value4,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
          ...
          DropdownButton<String>(
            ...
            child :
            //Printing Item on Text Widget 
            Text('Physics for Information Science', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value6,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('C Programming Lab', style: TextStyle(fontSize: 15, color: Colors.black54))),
          DropdownButton<String>(
            value: value7,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
