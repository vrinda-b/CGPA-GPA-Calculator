...
class ChemSem7 extends StatefulWidget {
  @override
  S7 createState() => S7();
}
      ...
      body: new Container(
        ...
        padding: new EdgeInsets.all(32.0),
          child : new Column(
            ...
            Text('Transport Phenomena', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            ...
            child :
            //Printing Item on Text Widget 
            Text('Process Equipment Design', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value2,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
          ...
          DropdownButton<String>(
            ...
            child :
            //Printing Item on Text Widget 
            Text('Process Control Lab', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value6,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Mass Transfer Lab', style: TextStyle(fontSize: 15, color: Colors.black54))),
          DropdownButton<String>(
            value: value7,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Internship', style: TextStyle(fontSize: 15, color: Colors.white60))),
          DropdownButton<String>(
            value: value8,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
