...
class BiotechSem2 extends StatefulWidget {
  @override
  S2 createState() => S2();
}
      ...
      body: new Container(
        ...
        padding: new EdgeInsets.all(32.0),
          ...
          DropdownButton<String>(
            ...
            child :
            //Printing Item on Text Widget 
            Text('Basic Civil and Mechanical Engineering', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value3,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Physics of Materials', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value4,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Microbiology', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value5,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Biochemistry', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value6,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Biochemistry Lab', style: TextStyle(fontSize: 15, color: Colors.black54))),
          DropdownButton<String>(
            value: value7,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
