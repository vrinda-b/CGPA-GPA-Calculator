      ...
      body: new Container(
        ...
        padding: new EdgeInsets.all(32.0),
          ...
          DropdownButton<String>(
            ...
            child :
            //Printing Item on Text Widget 
            Text('Process Planning and Cost Estimation', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value2,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Mechatronics', style: TextStyle(fontSize: 15, color: Colors.black))),
          DropdownButton<String>(
            value: value3,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
          ...
          DropdownButton<String>(
            ...
            child :
            //Printing Item on Text Widget 
            Text('Simulation and Analysis Lab', style: TextStyle(fontSize: 15, color: Colors.black54))),
          DropdownButton<String>(
            value: value7,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Mechatronics Lab', style: TextStyle(fontSize: 15, color: Colors.white60))),
          DropdownButton<String>(
            value: value8,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
            ...
            child :
            //Printing Item on Text Widget 
            Text('Technical Seminar', style: TextStyle(fontSize: 15, color: Colors.white60))),
          DropdownButton<String>(
            value: value8,
            icon: Icon(Icons.arrow_drop_down),
            iconSize: 24,
